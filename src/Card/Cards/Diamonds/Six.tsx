...
export default function SixOfDiamonds({ width }: { width: number }) {
  return (
    <svg
      version="1.2"
      baseProfile="tiny"
    ...
    >
      <defs>
        ...
        <path
          id="numeral"
          d="M0.313,22.581c-0.408-2.747-0.402-9.844-0.066-11.942C1.276,4.21,3.779,1.271,7.97,0.306c4.067-0.936,9.789,0.105,11.044,5.481L15.607,5.85c-1.84-3.634-6.495-2.661-9.115-1.082c-2.094,1.263-3.039,6.521-2.635,6.844c-0.003,0,3.957-2.877,7.076-2.665c6.668,0.682,9.417,6.354,9.184,11.719c-0.209,6.449-2.294,11.602-9.36,11.944C4.038,32.361,0.957,28.762,0.313,22.581zM16.882,20.876c0.037-4.476-2.033-7.822-5.948-8.192c-3.916-0.368-7.864,3.382-7.591,7.942c0.273,4.578,2.078,8.434,6.825,8.412C15.276,29.014,16.857,24.061,16.882,20.876L16.882,20.876z"
        />
      </defs>
